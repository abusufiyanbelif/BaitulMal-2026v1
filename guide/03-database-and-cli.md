...
### `npm run db:migrate-beneficiaries`

-   **Purpose**: Finds beneficiaries in Campaign/Lead subcollections that don't exist in the master `/beneficiaries` list and adds them.
-   **When to Run**: Run this script if you suspect that some beneficiaries created within specific initiatives are missing from the central master list.
