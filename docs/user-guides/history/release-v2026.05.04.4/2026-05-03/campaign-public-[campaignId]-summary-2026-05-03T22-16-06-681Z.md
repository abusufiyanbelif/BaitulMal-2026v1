...
## 🧪 Reproducible Steps
- Navigate to `/campaign-public/[campaignId]/summary` through the institutional dashboard.
...
- **Back To Public Campaigns**: Interactive button to initiate back to public campaigns operation.
