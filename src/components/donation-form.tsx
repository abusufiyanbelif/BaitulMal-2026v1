        ...
        <div className="space-y-4 rounded-xl border border-primary/10 p-4 bg-white shadow-sm">
          ...
          {isLinkSplit ? (
            <div className="space-y-4 pl-6 animate-fade-in-up">
                ...
                {!isReadOnly && <Button type="button" variant="outline" size="sm" onClick={() => appendLinkSplit({ linkId: 'unlinked', amount: 0 })} className="font-bold text-primary border-primary/20 transition-transform active:scale-95 shadow-none"><Plus className="mr-2 h-4 w-4"/> Allocate Another Initiative</Button>}
            </div>
          ) : (
