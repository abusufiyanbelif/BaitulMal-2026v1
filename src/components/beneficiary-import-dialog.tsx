            ...
            <div className="flex-1 min-h-0 space-y-4 flex flex-col">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 shrink-0">
                    ...
                    <div className="p-3 rounded-xl bg-red-50 border border-red-100 flex items-center gap-3">
                        ...
                        <div><p className="text-[10px] font-bold capitalize text-red-800 tracking-widest">Invalid Rows</p><p className="text-lg font-bold text-red-900 leading-none">{processedRecords.filter(r => !r.isValid).length}</p></div>
                    </div>
                </div>
