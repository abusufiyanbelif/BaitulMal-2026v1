...
import { ArrowLeft, Edit, Download, Loader2, Image as ImageIcon, FileText, Share2, FolderKanban, Lightbulb, ZoomIn, ZoomOut, RotateCw, RefreshCw, AlertCircle, ShieldCheck, Clock, History, Calendar } from 'lucide-react';
    ...
    if (!donation || !campaign) {
        return (
            <main className="container mx-auto p-4 md:p-8 text-center font-normal">
                <p className="text-lg text-muted-foreground font-bold opacity-60">Donation Or Campaign Record Not Found.</p>
                <Button asChild className="mt-4 font-bold border-primary/20 text-primary transition-transform active:scale-95" variant="outline"><Link href="/campaign-members"><ArrowLeft className="mr-2 h-4 w-4" /> Back To Campaigns</Link></Button>
            </main>
        );
    }
                    ...
                    <div className="grid gap-6 grid-cols-1 lg:grid-cols-12">
                        <div className="lg:col-span-8 space-y-6">
                            <Card className="border-primary/10 shadow-sm bg-white overflow-hidden">
                                <CardHeader className="bg-primary/5 border-b"><CardTitle className="text-lg font-bold tracking-tight text-primary">Contribution Summary</CardTitle></CardHeader>
                            ...
                            <Card className="border-primary/10 shadow-sm bg-white overflow-hidden">
                                ...
                                <CardContent className="grid gap-6 md:grid-cols-2 pt-6">
                                    ...
                                    <div className="space-y-3">
                                        <h3 className="text-[10px] font-bold text-muted-foreground capitalize tracking-widest">Initiative Allocation</h3>
                                        <div className="border border-primary/5 rounded-xl overflow-hidden shadow-inner">
                                            <ScrollArea className="w-full">
                                                <Table>
                                                    <TableHeader className="bg-primary/5">
                                                        <TableRow><TableHead className="font-bold text-primary text-[9px] capitalize tracking-tighter">Initiative</TableHead><TableHead className="text-right font-bold text-primary text-[9px] capitalize tracking-tighter">Amount</TableHead></TableRow>
                                                    </TableHeader>
                                                    <TableBody>
                            ...
                            <Card className="border-primary/10 shadow-sm bg-white overflow-hidden">
                                ...
                                <CardContent className="pt-6 space-y-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-bold text-muted-foreground capitalize tracking-tighter">Registry Entry Secured</p>
                                    ...
                                    {donation.createdAt && (
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-bold text-muted-foreground capitalize tracking-tighter">Creation Timestamp</p>
                                            ...
                                            <Table>
                                                <TableHeader className="bg-muted/50">
                                                    <TableRow>
                                                        ...
                                                        <TableHead className="text-right font-semibold text-muted-foreground text-xs uppercase tracking-wider h-10 pr-6">Validation Artifact</TableHead>
                                                    </TableRow>
                                                </TableHeader>
                                                <TableBody>
                        ...
                        <Card className="border-primary/10 shadow-sm bg-white overflow-hidden">
                            ...
                            <CardContent className="space-y-6 pt-6">
                                ...
                                {donation.suggestions && (
                                    <div className="space-y-1"><p className="text-[10px] font-bold text-muted-foreground capitalize tracking-widest">Member Recommendations</p><p className="text-sm font-normal bg-primary/[0.02] p-4 rounded-lg italic border border-primary/5 leading-relaxed">"{donation.suggestions}"</p></div>
                                )}
                            </CardContent>
                        </Card>
                    )}
            ...
            <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
                <DialogContent className="max-w-2xl h-[90vh] flex flex-col p-0 overflow-hidden rounded-[16px] border-primary/10">
                    ...
                    <div className="flex-1 overflow-hidden relative">
                        <DonationForm donation={donation} onSubmit={handleFormSubmit} onCancel={() => setIsFormOpen(false)} campaigns={allCampaigns || []} leads={allLeads || []} defaultLinkId={`campaign_${campaignId}`} />
                    </div>
                </DialogContent>
            </Dialog>
            ...
            <Dialog open={isImageViewerOpen} onOpenChange={setIsImageViewerOpen}>
                <DialogContent className="max-w-4xl max-h-[95vh] flex flex-col p-0 rounded-[12px] border-primary/10 overflow-hidden shadow-2xl animate-fade-in-zoom">
                    <DialogHeader className="px-6 py-4 bg-primary/5 border-b">
                        <DialogTitle className="text-xl font-bold text-primary tracking-tight capitalize tracking-widest">{imageToView?.title || 'Evidence Viewer'}</DialogTitle>
                    </DialogHeader>
                    ...
                    <DialogFooter className="sm:justify-center pt-4 flex-wrap gap-2 px-6 py-4 border-t bg-white flex">
                        ...
                        <Button variant="secondary" size="sm" onClick={() => { setZoom(1); setRotation(0); }} className="font-bold text-[10px] border-primary/10 text-primary transition-transform active:scale-95"><RefreshCw className="mr-2 h-4 w-4"/> Reset</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
            <ShareDialog 
                ...
                shareData={{
                    ...
                    text: getDonationShareText(donation, { campaignName: campaign?.name }),
