    ...
    if (!donation || !campaign) {
        return (
            <main className="container mx-auto p-4 md:p-8 text-center">
                <p className="text-lg text-muted-foreground font-normal">Donation or campaign not found.</p>
                <Button asChild className="mt-4 font-bold"><Link href="/campaign-members"><ArrowLeft className="mr-2 h-4 w-4" /> Back to campaigns</Link></Button>
            </main>
        );
    }
