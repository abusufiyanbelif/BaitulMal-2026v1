...
function BeneficiaryListContent() {
  ...
  const handleExport = () => {
    ...
    const headers = ['ID', 'Name', 'Phone', 'Address', 'Age', 'Occupation', 'Total Members', 'Earning Members', 'Male', 'Female', 'ID Type', 'ID Number', 'Referral By', 'Requirement Amount', 'Zakat Eligible', 'Zakat Allocation', 'Verification Status', 'Disbursement Status', 'Notes'];
    ...
    link.setAttribute("download", `beneficiaries_full_camp_${campaignId}.csv`);
        ...
        <div className="border-b border-primary/10 mb-4">
            <ScrollArea className="w-full whitespace-nowrap">
                <div className="flex w-max space-x-2 pb-2">
                    ...
                    <Link href={`/campaign-members/${campaignId}/audit`} className={cn("inline-flex items-center justify-center whitespace-nowrap rounded-md px-4 py-2 text-sm font-bold transition-all duration-200", pathname.endsWith('/audit') ? "bg-primary text-white shadow-md" : "text-muted-foreground font-bold hover:bg-primary/10 hover:text-primary")}>Audit Trail</Link>
                </div>
