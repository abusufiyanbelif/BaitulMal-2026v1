...
export default function CreateCampaignPage() {
  ...
  useMemo(() => {
    const suggested = getDefaultImage(category);
    ...
    try {
        ...
        if (hasImageToUpload) {
            ...
            try {
                ...
                const storageFolder = getStorageFolderPath('campaigns', data.caseId, newCampaignId);
          ...
          <CardContent className="pt-6">
            <Form {...form}>
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-3 pt-6 border-t mt-6 bg-background/80 backdrop-blur-sm sticky bottom-0 p-4 z-50 shrink-0">
                  ...
                  <Button type="submit" disabled={isLoading} className="w-full sm:w-auto font-bold shadow-md transition-transform active:scale-95 px-8">
