                                        ...
                                        <div className="border rounded-lg overflow-hidden font-normal text-foreground shadow-sm min-w-[650px] border-primary/10 mx-4 sm:mx-0">
                                            {isRationInitiative ? (
                                                ...
                                                <Table>
                                                    <TableHeader className="bg-[hsl(var(--table-header-bg))]">
                                                        <TableRow>
                                                            <TableHead className="font-semibold text-[hsl(var(--table-header-fg))] text-[10px] tracking-tight capitalize">Requirement Description</TableHead>
                                                            ...
                                                            <TableHead className="text-right font-semibold text-[hsl(var(--table-header-fg))] text-[10px] tracking-tight capitalize">Total Price</TableHead>
                                                        </TableRow>
                                                    </TableHeader>
                                                    <TableBody>
                                                    ...
                                                    <TableFooter className="bg-primary/5 border-t">
                                                        <TableRow>
                                                            <TableCell colSpan={3} className="text-right font-bold text-primary text-[10px] tracking-tight capitalize">Single Beneficiary Total</TableCell>
