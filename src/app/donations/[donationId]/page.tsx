...
export default function UnlinkedDonationDetailsPage() {
    ...
    const handleShare = () => {
        if (!donation) return;
        const shareText = `JazakAllah Khair for your generous donation of ₹${donation.amount.toFixed(2)}. May Allah accept it and bless you abundantly.`;
    ...
    const handleDownload = async (format: 'png' | 'pdf') => {
        ...
        try {
            ...
            if (format === 'png') {
                ...
                ctx.fillText('Donation Receipt', PADDING, HEADER_HEIGHT);
