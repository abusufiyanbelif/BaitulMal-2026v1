...
import { Settings, Save, Loader2, CheckSquare, Edit, X, UserSearch } from 'lucide-react';
        ...
        <div className="flex justify-between items-center">
            ...
            {!isEditMode ? (
                ...
                <div className="flex gap-2">
                    <Button variant="outline" onClick={() => setIsEditMode(false)} className="font-bold border-primary/20 text-primary transition-transform active:scale-95">
