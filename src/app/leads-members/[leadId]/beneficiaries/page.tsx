    ...
    <main className="container mx-auto p-4 md:p-8 space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-3 bg-muted/10 p-4 rounded-xl border">
            <div className="relative flex-1 min-w-[200px]">
                ...
                <Input placeholder="Search by name, phone, referral..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-9 h-9 text-xs" />
            </div>
        ...
        <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
            <AlertDialogContent>
                <AlertDialogHeader><AlertDialogTitle>Confirm Deletion</AlertDialogTitle><AlertDialogDescription>This will remove the beneficiary from this lead. The master record will remain intact.</AlertDialogDescription></AlertDialogHeader>
                <AlertDialogFooter>
