          ...
          <CardHeader className="p-4 border-b bg-primary/5">
            <ScrollArea className="w-full">
                <div className="flex flex-nowrap items-center gap-3 pb-2">
                    ...
                    <Select value={statusFilter} onValueChange={setStatusFilter} disabled={isLoading}><SelectTrigger className="w-[130px] h-9 text-xs text-primary font-normal"><SelectValue placeholder="All Statuses" /></SelectTrigger><SelectContent><SelectItem value="All" className="font-normal uppercase">All Statuses</SelectItem><SelectItem value="Active" className="font-normal uppercase">Active</SelectItem><SelectItem value="Completed" className="font-normal uppercase">Completed</SelectItem><SelectItem value="Upcoming" className="font-normal uppercase">Upcoming</SelectItem></SelectContent></Select>
